...
namespace NoMercy.Database.Migrations.Queue
{
    ...
    [Migration("20260110175039_AddEncoderV2Models")]
    partial class AddEncoderV2Models
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoMercy.Database.Models.EncodingNodeAssignment", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(256)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("EncodingNodeAssignments");
                });
            ...
            modelBuilder.Entity("NoMercy.Database.Models.EncodingJob", b =>
                {
                    b.HasOne("NoMercy.Database.Models.EncoderProfile", "Profile")
                        .WithMany()
